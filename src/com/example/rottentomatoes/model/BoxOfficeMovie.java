...
public class BoxOfficeMovie {
 ...
 // Decodes array of box office movie json results into business model objects
    ...
    public static ArrayList<BoxOfficeMovie> fromJson(JSONArray jsonArray) {
        ArrayList<BoxOfficeMovie> movieList = new ArrayList<BoxOfficeMovie>(jsonArray.length());
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            BoxOfficeMovie movie = BoxOfficeMovie.fromJson(businessJson);
            if (movie != null) {
            	movieList.add(movie);
            }
        }
